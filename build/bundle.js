...
var app = (function () {
    ...
    /* public\components\PageTransition.svelte generated by Svelte v3.44.3 */
    const file$2 = "public\\components\\PageTransition.svelte";
    ...
    function create_key_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 6, 4, 118);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ fade, refresh });
    ...
    class PageTransition extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { refresh: 0 });
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ PageTransition });
    	return [];
    }
